...
class hefoold extends StatefulWidget {
  const hefoold({Key? key}) : super(key: key);

  @override
  State<hefoold> createState() => _hefooldState();
}

class _hefooldState extends State<hefoold> {
  _hefooldState createState() => new _hefooldState();
  int _itemCount1 = 0;
  int _itemCount2 = 0;
  int _itemCount3 = 0;
  int _itemCount4 = 0;
